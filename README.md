> **RAG Enhancement**: This fork adds vector retrieval (bge-base-zh-v1.5 + Chroma) and GraphRAG (Neo4j CO_CITED) modules. See [README-RAG.md](./README-RAG.md) for details.
